...
class timeliness_heinrich_config(MetricConfig):
    ...
    :param to_datetime_kwargs: Optional keyword arguments for pandas.to_datetime when parsing the ingestion date column.
    ...
    def to_json(self):
        return {
            ...
            "to_datetime_kwargs": self.to_datetime_kwargs,
        }
