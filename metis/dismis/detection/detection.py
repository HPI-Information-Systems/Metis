...
def run_detection_algorithms(
    ...
    detector_mapper = {
        ...
        "BucketPDFGoF": lambda data: BucketPDFGoF(
            target_types=["numeric", "date"]
        ),  # checked #checked
        "pyod_knn": lambda data: PyODDetector(
            "KNN", target_types=["numeric", "date"]
        ),  # checked #checked
        "pyod_lof": lambda data: PyODDetector(
            "LOF", target_types=["numeric", "date"]
        ),  # checked #checked
        ...
        "pyod_cof": lambda data: PyODDetector(
            "COF", target_types=["numeric", "date"]
        ),  # checked #checked
        "pyod_gmm": lambda data: PyODDetector(
            "GMM", target_types=["numeric", "date"]
        ),  # checked #checked
        "pyod_mad": lambda data: PyODDetector(
        ...
        "ESD": lambda data: PyODDetector(
            "ESD", target_types=["numeric", "date"]
        ),  # checked #checked
        ...
        "quantile": lambda data: QuantileDetector(
            target_types=["numeric", "date"]
        ),  # checked #checked
